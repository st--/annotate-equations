...
\verb|\eqnannotationfont| is a one-argument command that feeds into the
\texttt{font} field of tikz and can be used to have consistent formatting:
\begin{LTXexample}[text outside listing,lefthand width=0.5in]
% package default:
...
\verb|\eqnannotationstrut| is defined to be a strut to provide minimum distance
from text to the surrounding diagrams. By default it is \verb|\strut|, which has
a similar effect to \verb|\mathstrut| in \verb|\eqnhighlightheight|.
