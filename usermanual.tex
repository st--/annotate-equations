...
\author{ST John}
\date{\url{https://github.com/st--/annotate_equations}}
...
\vspace{1em}
\end{LTXexample}
There is still a bit of manual tweaking required, but hopefully this will make it a bit less painful to annotate your equations!
